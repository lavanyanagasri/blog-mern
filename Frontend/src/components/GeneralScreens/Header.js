    ...
    return (
        <header className="bg-black shadow-md py-3">
            <div className="container mx-auto px-4 flex justify-between items-center flex-wrap gap-4">
                ...
                {/* Logo */}
                <Link to="/" className="text-2xl font-bold flex ml-4">
                ...
                <div className="flex items-center gap-4">
                    {auth ? (
                        <div className="flex items-center gap-4">
                            ...
                            <Link 
                                to="/addstory" 
                                className="flex items-center gap-1 text-sm text-green-500 hover:text-green-400 font-medium"
                            >
                                <RiPencilFill />
                                Add Story
                            </Link>
                            ...
                            <Link 
                                to="/readList" 
                                className="relative text-sm text-purple-500 hover:text-purple-400 font-medium"
                            >
                            ...
                            <div className="relative group">
                                ...
                                {/* Profile Dropdown */}
                                <div className="absolute hidden group-hover:flex flex-col right-0 mt-2 bg-white border rounded shadow-lg z-50 w-36">
                                    <Link 
                                        to="/profile" 
